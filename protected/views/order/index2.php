...
<div class="order_nav w100" id="hdNav">
    <ul>
        ...
        <li class="order_nav_bt_area fr"><a href="/order/index2" class="order_nav_bt selected ">订单明细</a></li>
        <li class=" fr"><a href="/order/show" class="order_nav_bt ">订单统计</a></li>
    </ul>
</div>
<!--主导航-->
<!--右侧主区域-->
        ...
        $(window).scroll(function(){
            ...
            if($(document).height() <= totalheight + 120){
                if(stop==true){
                    ...
                    $.get("/order/detail", {'page':page},function(txt){
                        if (txt) {
                            $(".load-div").append(txt);
                            $('#page').val(page + 1);
