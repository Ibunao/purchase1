<?php // var_dump($model['list']);die;?>
<?php echo $this->renderPartial('/common/_nav',array('model'=>$model,'c_id'=>$c_id,'b_id'=>$b_id));?>
<!--右侧主区域-->
...
<?php echo $this->renderPartial('/common/_footer',array());?>